    ...
    >
      ...
      <div class="hidden w-full md:block md:w-auto" id="navbar-multi-level">
        ...
        >
          ...
          <li @mouseover="mainDropDown()" @mouseleave="mainMouseLeave()">
            <button
...
export default {
  ...
  methods: {
    mainDropDown: function () {
      let element = document.getElementById("dropdownNavbar");

      element.style.display = "inline-block";
      element.style.position = "absolute";
    },
    mainMouseLeave: function () {
      const element = document.getElementById("dropdownNavbar");
      element.style.display = "none";
    },

    subDropDown: function () {
      let element = document.getElementById("doubleDropdown");

      element.style.display = "inline-block";
      element.style.position = "absolute";
    },
    subMouseLeave: function () {
      const element = document.getElementById("doubleDropdown");
      element.style.display = "none";
    },
  },
};
